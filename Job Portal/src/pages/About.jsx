...
const values = [
  {
    icon: Shield,
    title: "Cadet-first",
    desc: "Built around what NCC cadets uniquely bring to the table.",
  },
  {
    icon: Sparkles,
    title: "AI, transparent",
    desc: "Every match comes with a reason — and a path to improve.",
  },
  {
    icon: Users,
    title: "Community",
    desc: "From cadets, for cadets — with mentors who've been there.",
  },
    ...
    <PublicLayout>
      <section className="mx-auto max-w-4xl px-6 pt-20 pb-10 text-center">
        ...
        <h1 className="mt-4 text-4xl sm:text-5xl font-display font-extrabold">
          A career platform built for cadets.
        </h1>
        <p className="mt-5 text-lg text-muted-foreground">
          NCC Career AI helps cadets translate years of discipline, leadership and training into
          careers they're proud of — with AI that understands their full story.
        </p>
      </section>
