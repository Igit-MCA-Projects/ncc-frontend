    ...
    <DashboardLayout>
      ...
      <div className="mt-6 grid gap-4 max-w-2xl">
        <Toggle
          icon={Moon}
          title="Dark mode"
          desc="Easier on the eyes during late drills."
          value={dark}
          onChange={setDark}
        />
        ...
        <div className="card-soft p-5 flex items-center justify-between">
          <div>
            ...
            <div className="text-sm text-muted-foreground">
              Sign out of NCC Career AI on this device.
            </div>
          </div>
          <button
  ...
  return (
    <div className="card-soft p-5 flex items-center justify-between gap-4">
      ...
      <button
        ...
        aria-pressed={value}
        className={
          "shrink-0 h-7 w-12 rounded-full transition-colors " + (value ? "bg-primary" : "bg-muted")
        }
      >
        <span
          className={
